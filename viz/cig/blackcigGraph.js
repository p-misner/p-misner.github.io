...
console.log("run")
      ...
      d3.json("https://raw.githubusercontent.com/p-misner/100daysofvisualization/master/viz000/YRBSS_graphic/YRBSS_CigData.json", function(data) {console.log(data);setUp(data); controls(data);});
